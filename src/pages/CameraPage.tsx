...
// ---- Per-grade config for curriculum-appropriate content ----
const gradeCamera: Record<number, {
  title: string; desc: string;
  vocabLabel: string; vocabDesc: string;
  grammarLabel: string; grammarDesc: string;
  unitLabel: string;
}> = {
  6: {
    title: "Lớp 6 · SGK Global Success",
    desc: "Ôn từ vựng và ngữ pháp cơ bản qua cử chỉ — phù hợp chương trình lớp 6",
    vocabLabel: "Từ vựng", vocabDesc: "Anh ↔ Việt · Dịch nghĩa từ",
    grammarLabel: "Ngữ pháp", grammarDesc: "Thì hiện tại · Câu đơn giản",
    unitLabel: "Chọn Unit",
  },
  7: {
    title: "Lớp 7 · SGK Global Success",
    desc: "Luyện từ vựng theo chủ đề và ngữ pháp nâng cao qua cử chỉ cơ thể",
    vocabLabel: "Từ vựng", vocabDesc: "Anh ↔ Việt · Chủ đề mở rộng",
    grammarLabel: "Ngữ pháp", grammarDesc: "So sánh · Thì quá khứ",
    unitLabel: "Chọn Unit",
  },
  8: {
    title: "Lớp 8 · SGK Global Success",
    desc: "Củng cố vốn từ và cấu trúc ngữ pháp phức tạp hơn qua vận động",
    vocabLabel: "Từ vựng", vocabDesc: "Anh ↔ Việt · Từ nâng cao",
    grammarLabel: "Ngữ pháp", grammarDesc: "Câu bị động · Mệnh đề quan hệ",
    unitLabel: "Chọn Unit",
  },
  9: {
    title: "Lớp 9 · Ôn thi vào 10",
    desc: "Tổng ôn từ vựng và ngữ pháp trọng tâm — sẵn sàng cho kỳ thi vào lớp 10!",
    vocabLabel: "Từ vựng", vocabDesc: "Anh ↔ Việt · Trọng tâm thi",
    grammarLabel: "Ngữ pháp", grammarDesc: "Tổng hợp · Đề thi thử",
    unitLabel: "Chọn Unit",
  },
  10: {
    title: "Lớp 10 · Chuyên đề",
    desc: "Trắc nghiệm từ vựng, ngữ pháp và đề thi chuyên sâu qua camera",
    vocabLabel: "Từ vựng", vocabDesc: "Trắc nghiệm A/B chuyên đề",
    grammarLabel: "Ngữ pháp", grammarDesc: "Trắc nghiệm A/B nâng cao",
    unitLabel: "Chọn đề thi",
  },
};
      ...
      try {
        ...
        for (const delegate of ["GPU", "CPU"] as const) {
          try {
            ...
            console.warn(`PoseLandmarker ${delegate} failed, trying next...`, delegateErr);
          }
        }
        ...
        if (poseLandmarker) {
          ...
          setPoseError("Không thể khởi tạo pose detection");
        }
      } catch (e) {
        console.error("MediaPipe load error:", e);
        if (!cancelled) setPoseError("Lỗi tải MediaPipe: " + (e instanceof Error ? e.message : String(e)));
      }
    }
  ...
  useEffect(() => {
    ...
    const detect = () => {
      ...
      if (video && poseLandmarker && video.readyState >= 2) {
        ...
        } catch (err) { console.warn("Detection frame error:", err); }
      }
...
const CameraPage = () => {
  ...
  const gcfg = gradeCamera[grade] || gradeCamera[6];
