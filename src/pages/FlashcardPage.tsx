        ...
        <div className="flex-1 flex items-center justify-center px-5 py-8">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`w-full max-w-sm aspect-[3/4] rounded-3xl shadow-xl flex flex-col items-center justify-center cursor-pointer select-none p-8 border border-white/40 relative overflow-hidden ${
                flipped ? "gradient-purple-card text-white" : "bg-card"
              }`}
            >
